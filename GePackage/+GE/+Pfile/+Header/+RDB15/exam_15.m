function strct = ge_read_exam_header_rdb15(pfile_name,offset)
...
strct = setfield(strct, 'double_padding', fread(fid,9,'double','ieee-le')); % Please use this if you are adding any doubles
...
strct = setfield(strct, 'int_padding', fread(fid,12,'int32','ieee-le')); % Please use this if you are adding any ints
...
strct = setfield(strct, 'short_padding', fread(fid,11,'int16','ieee-le')); % Please use this if you are adding any shorts
...
strct = setfield(strct, 'ex_padding', char(fread(fid,62,'char','ieee-le'))); % Spare Space only for BLOCKs
